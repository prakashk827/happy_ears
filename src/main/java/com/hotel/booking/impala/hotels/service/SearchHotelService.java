package com.hotel.booking.impala.hotels.service;
...
import com.hotel.booking.utils.EncodeURL;
...
public class SearchHotelService {
    ...
    public ImpalaHotelDTO searchHotels(Map<String, String> requestParamMap) {
        ...
        try {
            ...
            throw new HRBException(HttpStatus.INTERNAL_SERVER_ERROR.value(), e.getResponseBodyAsString(), new ArrayList<>());

        } catch (RestClientException e) {
            //APP_LOG.info("Something went wrong RestClientException callDigitapAPI():  " + e);
            throw new HRBException(HttpStatus.INTERNAL_SERVER_ERROR.value(), e.getMessage(), new ArrayList<>());
